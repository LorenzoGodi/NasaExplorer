...
namespace NasaExplorer
{
    ...
    /// </summary>
    public sealed partial class SubHome_epic_Page : Page
    {
        public SubHome_epic_Page()
        {
            this.InitializeComponent();
            //JJJ();
            Download("https://epic.gsfc.nasa.gov/epic-archive/jpg/epic_1b_20151031003633.jpg");
        }
